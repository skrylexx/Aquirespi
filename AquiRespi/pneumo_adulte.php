...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stylePneumoAdulte.css">
...
<body>
    ...
    <div class="divRetour"><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>" class="blue"><span class="class font">Retour</span></a></div>
        <article>
            <div class="jsp"><h2>Nos services de pneumologie chez l'adulte :</h2></div>
                <div class="divListe">
                    <ul class="listeG">
                        <li class="vert bot">BPCO</li>
                        <li class="bot">Asthme</li>
                        <li class="orange">Mucoviscidose</li>
                    </ul>
                    <ul class="listeD">
                        <li class="bot">Covid</li>
                        <li class="bot">SAHOS</li>
                        <li>Autre</li>
                    </ul>
                </div>
        </article>
